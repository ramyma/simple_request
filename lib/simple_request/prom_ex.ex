defmodule SimpleRequest.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule SimpleRequestWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :simple_request

       ...

       plug PromEx.Plug, prom_ex_module: SimpleRequest.PromEx
  ...
  use PromEx, otp_app: :simple_request
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: SimpleRequestWeb.Router, endpoint: SimpleRequestWeb.Endpoint},
      Plugins.Ecto
      # Plugins.Oban,
      ...
      # SimpleRequest.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:simple_request, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
